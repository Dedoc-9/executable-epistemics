# Run Notes — Repository 6 of 20: pytest-dev/pytest
...
## Pin
- Ground-truth chain: 04905fe173f2dd41 · E-006 filter = 10
...
|---|---|---|---|---|
| dep_graph | 0.063894 | 0.209531 | 0.382429 | NOT_DETECTED |
| ast_metrics | 0.382429 | 0.410361 | 0.382429 | NOT_DETECTED |
| ownership | 0.410361 | 0.408933 | 0.382429 | DETECTED |

## Scrutiny items
- ownership DETECTED by razor-thin margin (0.001428): classification mechanically valid; margin recorded without interpretation.

## Committed action (per §A, clean-pipeline row)
Record (this file) → commit → push → proceed to next declared repository.
No theoretical update. Campaign: 6/20 scored. Erratum budget: 1 of 3 used.
